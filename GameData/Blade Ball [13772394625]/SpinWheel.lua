data = {
    ["SpinWheelRewards"] = {
        ["Default"] = {
            ...
            },
            {
                ...
                ["chance"] = 5,
                ["displayText"] = "Gilded Glory",
                ["icon"] = "rbxassetid://15961297462",
                ["rewardText"] = "Gilded Glory"
            },
            {
                ["wheelText"] = "Coins",
        ...
        ["NewYear"] = {
            ...
            {
                ["name"] = "awardSword_Nebula Bow",
                ["bottomText"] = "CUSTOM VFX",
                ["chance"] = 1,
                ["displayText"] = "Nebula Bow",
                ["icon"] = "rbxassetid://15798130925",
                ["rewardText"] = "Nebula Bow"
            },
            {
                ["wheelText"] = "Coins",
                ["name"] = "fiveHundredCoins",
    ...
    ["SpinWheelSettings"] = {["MAX_COIN_SPINS"] = 3, ["COIN_SPIN_COOLDOWN"] = 86400, ["COIN_SPIN_PRICE"] = 3000}
}
