data = {
    ...
    A teardrop falls from Evelynn’s eye as the portal swirls shut.]],
                ["subtitle"] = "A Lovers' Quarrel",
                ["author"] = "Grishma",
        ...
        ["none"] = {
            ["notGiftable"] = true,
            ["name"] = "None",
            ["renderImage"] = "rbxassetid://16493320215",
            ["description"] = ""
        },
        ["ember"] = {
            ["notGiftable"] = true,
...
<b>Chapter III:</b>
    ...
    I watch as the demons guide the woman out of the hall and wonder if I could be as graceful as her if I were in her shoes. I hope she does not regret her impertinence, even though I am almost confident she will. The thought lingers in my mind for a fleeting moment before the next unfortunate soul is dragged in front of my eyesight as the vicious cycle of hell continues for another eternity.]],
                ["subtitle"] = "The Weight of Power",
                ["author"] = "Grishma",
                ["storyTitle"] = "Sins of the Soul"
            },
        ...
        ["agni"] = {
            ...
            ["name"] = "Agni",
            ["lore"] = {
                ["story"] = [[    The moonless night is devoid of stars. The air is bone-chillingly cold. The wind is howling as the intense snowstorm continues. Everything you can lay your eyes on is covered with a thick layer of white snow. Our little camp lies next to the tree line of the forest grounds, tucked under the covers of tall bushes.
...
<i>(Part of the Holiday 2021 Bundle)</i>]],
        ...
        ["falconer"] = {
            ["forgeGearSubstitutes"] = {
                ["wood_bow"] = "falconer_bow",
                ["wood_crossbow"] = "falconer_crossbow",
                ["headhunter"] = "falconer_headhunter"
            },
            ["name"] = "Bekzat",
            ["battlepassSeason"] = "season10",
            ["unlockedInBattlePass"] = true,
...
<i>(Part of the Holiday 2022 Bundle)</i>]]
    ...
    “Free will?” I inquire.
    “Free will,” she confirms and continues. “So, are you ready?”]],
                ["subtitle"] = "The God of Death",
                ["author"] = "Grishma",
