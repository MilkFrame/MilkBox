...
data = {
    ["Stars"] = {
        ...
        {2, "ycnequinto", 746449, 16918672698},
        {3, "eleg6nce", 720278, 16918682079},
        {4, "lecfosii", 704505, 14632006848},
        {5, "xxdumpfreyxxx", 610156, 14632006848},
        {6, "Roeberryberry", 604659, 14632006848},
        {7, "fatalgirll", 411717, 14632006848},
        {8, "dhviine", 404722, 14632006848},
        {9, "f7deral", 326877, 14632006848},
        {10, "hoshifixation", 312070, 14632006848}
    },
    ["Wins"] = {
        {1, "MELM1130", 4656, 16918636081},
        {2, "beatrizdosreisYT", 4413, 16918672698},
        {3, "folkloreair", 4305, 16918682079},
        {4, "RequipAltairis", 4183, 14632006848},
        {5, "ycnequinto", 4141, 14632006848},
        {6, "trixiecatiex", 4106, 14632006848},
        {7, "xxdumpfreyxxx", 3495, 14632006848},
        {8, "OfficialTrinChanel", 3489, 14632006848},
        {9, "idarkMix", 3308, 14632006848},
        {10, "Roeberryberry", 3298, 14632006848}
    },
    ["Donations"] = {
